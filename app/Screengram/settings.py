...
# DEPLOYMENT_MODE: saas | self_hosted | hybrid | client — see core.deployment.resolve_effective_platform_saas
...
INSTALLED_APPS = [
    ...
    'mother_client',  # Sync with mother platform (register, heartbeat, usage)
...
MIDDLEWARE = [
    ...
    'core.mother_saas_enforcement_middleware.MotherSaasPlatformEnforcementMiddleware',
...
CELERY_BEAT_SCHEDULE = {
    'mother-send-heartbeat': {
        'task': 'mother_client.tasks.mother_send_heartbeat',
        'schedule': timedelta(seconds=60),
    },
    'mother-send-usage-report': {
        'task': 'mother_client.tasks.mother_send_usage_report',
